...
def criar_pergunta(OPENAI_API_KEY, assunto, tipo, dificultade, pergunta_exemplo = None):
  ...
  prompt = f'{assunto}. {tipo}. {dificultade}. {pergunta_exemplo}'
...
def responder_pergunta(OPENAI_API_KEY, pergunta_a_ser_respondida):
